...
import { LayoutDashboard, ShoppingBag, Mail, Radio, CreditCard, LogOut, ExternalLink, Package, Gift } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Giveaway', href: '/admin/giveaway', icon: Gift },
